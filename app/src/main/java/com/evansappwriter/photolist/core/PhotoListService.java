...
public class PhotoListService {
    ...
    private static final String API_KEY = "e640a3626bbf076af77fa476e5559366";

    @SuppressWarnings("ConstantConditions")
    private static final String REST_API = " https://api.flickr.com";

    public static final String ENDPOINT_PHOTO_SEARCH = "/services/rest/?method=flickr.photos.search&format=json&nojsoncallback=1&api_sig=8b965e3304ac00fdaf46615585a23a15";
    ...
    public void getMockPhotos(Context context, OnUIResponseHandler handler) {
        InputStream in_s = context.getResources().openRawResource(R.raw.photos);
